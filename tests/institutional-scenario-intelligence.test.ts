...
describe('RC-1.6 - Institutional Scenario Intelligence', () => {
  ...
  it('Deve bloquear simulações que excedam limites fiduciários (Fail-Closed)', () => {
    ...
    const result = InstitutionalScenarioEngine.simulateScenario(inputs, baseContext);
  ...
  it('Deve bloquear hipercrescimento de receita sem base de funding/caixa', () => {
    ...
    const result = InstitutionalScenarioEngine.simulateScenario(inputs, contextSemCaixa);
