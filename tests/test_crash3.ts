...
console.log("technicalEvidence.available:", result.pureViewModel.technicalEvidence?.available);
console.log("score.available:", result.pureViewModel.score?.available);
console.log("historical.available:", result.pureViewModel.historicalEvolution?.available);
