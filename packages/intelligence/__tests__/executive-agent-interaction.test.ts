...
describe('@illumine/intelligence (Wave 17.10.1 Real Agent Interaction Flow)', () => {
  it('should execute real agent interaction returning 5-layer executive response on click', () => {
    const res = ExecutiveAgentExecutionRuntime.executeAction('cfo-intelligence-agent', 'Explicar variação', 'DREPage');
