...
describe('@illumine/governance (Wave 17.13 Real Browser Canonical Mount - Balance Sheet)', () => {
  it('should verify BalanceSheetPage.tsx uses ExecutiveDecisionGovernanceMount directly below PageHeader', () => {
