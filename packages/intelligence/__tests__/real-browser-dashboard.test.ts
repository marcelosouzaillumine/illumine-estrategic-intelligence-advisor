...
describe('@illumine/intelligence (Wave 17.13 Real Browser Canonical Mount - Dashboard)', () => {
  it('should verify DashboardPage.tsx uses ExecutiveDecisionIntelligenceMount directly below PageHeader', () => {
