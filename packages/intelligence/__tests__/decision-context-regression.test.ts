...
describe('@illumine/governance (Wave 18.1 Decision Context Regression Safety)', () => {
  it('should verify zero static page-id switches remain in decision governance engine (ADR-068)', () => {
