...
describe('@illumine/executive-page-governance (Wave 17.6 Phase 1 Page Governance Adapter)', () => {
  it('should create unified page context connecting existing agents (ADR-059)', () => {
    ...
    expect(pageContext.availableAgents).toContain('cfo-governance-agent');
  });
