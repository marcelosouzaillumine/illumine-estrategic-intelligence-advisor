...
export const TenantViolations = {
  ...
  EXECUTION_DEPTH_OVERFLOW: 'EXECUTION_DEPTH_OVERFLOW',
  INVALID_CACHE_SCOPE: 'INVALID_CACHE_SCOPE',
  TELEMETRY_BOUNDARY_VIOLATION: 'TELEMETRY_BOUNDARY_VIOLATION',
  RECURSIVE_RUNTIME_LOOP: 'RECURSIVE_RUNTIME_LOOP',
  STALE_CACHE_CONTAMINATION: 'STALE_CACHE_CONTAMINATION',
  LAZY_EXECUTION_HIDDEN_RESULT: 'LAZY_EXECUTION_HIDDEN_RESULT'
} as const;
