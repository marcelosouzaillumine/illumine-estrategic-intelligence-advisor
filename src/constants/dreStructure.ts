...
export const DRE_OFFICIAL_STRUCTURE: DreAccount[] = [
  { id: "ROB", nome: "(+) Receita Operacional Bruta", tipo: "SINTETICA", natureza: "RECEITA", parentId: null, ordem: 1, aceitaLancamento: true, calculaAutomaticamente: true, formula: "SUM(children)" },
  { id: "DED", nome: "(-) Deduções da Receita Bruta", tipo: "SINTETICA", natureza: "DEDUCAO", parentId: null, ordem: 2, aceitaLancamento: true, calculaAutomaticamente: true, formula: "SUM(children)" },
  ...
  { id: "CUSTOS", nome: "(-) Custo Mercadorias/Produtos/Serviços Vendidos", tipo: "SINTETICA", natureza: "CUSTO", parentId: null, ordem: 4, aceitaLancamento: true, calculaAutomaticamente: true, formula: "SUM(children)" },
  ...
  { id: "DESP_OPER", nome: "(-) Despesas Operacionais", tipo: "SINTETICA", natureza: "DESPESA", parentId: null, ordem: 6, aceitaLancamento: true, calculaAutomaticamente: true, formula: "SUM(children)" },
  ...
  { id: "DEP_AMORT", nome: "(-) Depreciação e Amortização", tipo: "SINTETICA", natureza: "DEPRECIACAO_AMORTIZACAO", parentId: null, ordem: 8, aceitaLancamento: true, calculaAutomaticamente: true, formula: "SUM(children)" },
  ...
  { id: "RESULT_FIN", nome: "(+/-) Resultado Financeiro", tipo: "SINTETICA", natureza: "FINANCEIRO", parentId: null, ordem: 10, aceitaLancamento: true, calculaAutomaticamente: true, formula: "SUM(children)" },
  { id: "OUTRAS_REC_DESP", nome: "(+/-) Outras Receitas / Despesas Operacionais", tipo: "SINTETICA", natureza: "OUTRAS_RECEITAS_DESPESAS", parentId: null, ordem: 11, aceitaLancamento: true, calculaAutomaticamente: true, formula: "SUM(children)" },
  ...
  { id: "PROV_IR_CSLL", nome: "(-) Provisões IRPJ/CSLL", tipo: "SINTETICA", natureza: "TRIBUTO_SOBRE_LUCRO", parentId: null, ordem: 13, aceitaLancamento: true, calculaAutomaticamente: true, formula: "SUM(children)" },
