...
export type RuntimeEventName = 
  ...
  | 'CONSTITUTIONAL_FORBIDDEN_ACTION'
  | 'CONSTITUTIONAL_DOCTRINE_DRIFT'
  | 'CONSTITUTIONAL_EROSION_PATTERN'
  | 'CONSTITUTIONAL_MIGRATION_EVENT'
  | 'CONSTITUTIONAL_QUARANTINE_ACTIVATION';
