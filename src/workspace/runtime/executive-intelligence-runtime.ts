...
import { getSectorProfile } from '../../core/intelligence/sector-behavior-profiles';
...
import { InstitutionalConfidenceEngine } from '../../capabilities/runtime/confidence/InstitutionalConfidenceEngine';
...
import { TemporalCausalityOutput } from '../../core/intelligence/temporal-causality-engine';
...
import { CalibrationEngine } from '../../capabilities/runtime/calibration/CalibrationEngine';
...
import { LongitudinalIntelligenceGuard } from '../../capabilities/runtime/coherence/LongitudinalIntelligenceGuard';
...
import { EmptyCycleIntegrityEngine } from '../../capabilities/runtime/integrity/EmptyCycleIntegrityEngine';
import { BenchmarkGovernanceRegistry } from '../../capabilities/runtime/integrity/BenchmarkGovernanceRegistry';
import { BenchmarkReferenceEngine } from '../../capabilities/runtime/integrity/BenchmarkReferenceEngine';
import { ScaleEfficiencyIntegrityEngine } from '../../capabilities/runtime/integrity/ScaleEfficiencyIntegrityEngine';
import { InvalidMetricGuard } from '../../capabilities/runtime/integrity/InvalidMetricGuard';
import { ExecutiveActionMatrixEngine, ExecutiveActionItem } from '../../capabilities/runtime/integrity/ExecutiveActionMatrixEngine';
import { HistoricalSeriesIntegrityEngine } from '../../capabilities/runtime/integrity/HistoricalSeriesIntegrityEngine';
import { ExecutiveEmptyStateResolver } from '../../capabilities/runtime/integrity/ExecutiveEmptyStateResolver';
import { ExecutiveDiagnosisComposer } from '../../core/executive-experience/ExecutiveDiagnosisComposer';
...
import { readRuntimeEnvironmentConfig } from '../../platform/config/RuntimeEnvironmentConfig';
...
import { ExecutiveNarrativeHarmonizer } from '../../capabilities/runtime/narrative/ExecutiveNarrativeHarmonizer';
