      ...
      <div className={cn("flex items-center gap-1", align === 'center' && "justify-center", align === 'right' && "justify-end")}>
        ...
        <div className="flex flex-col ml-1 items-center justify-center h-4">
          <ChevronUp 
            ...
            className={cn(
              "transition-colors", 
              isSorted && currentSort.direction === 'asc' ? "text-secondary" : "text-slate-300 opacity-0 group-hover:opacity-100"
            )} 
          />
          <ChevronDown 
            size={10} 
            className={cn(
              "transition-colors", 
              isSorted && currentSort.direction === 'desc' ? "text-secondary" : "text-slate-300 opacity-0 group-hover:opacity-100"
            )} 
          />
        </div>
      </div>
