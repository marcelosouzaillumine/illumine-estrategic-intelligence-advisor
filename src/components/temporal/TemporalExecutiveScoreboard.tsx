...
export const TemporalExecutiveScoreboard: React.FC<ScoreboardProps> = ({ temporalData }) => {
  ...
  return (
    <div className="temporal-scoreboard p-6 bg-gray-900 border border-gray-800 rounded-lg shadow-xl text-white">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="score-panel p-4 bg-gray-800 rounded-md">
          <div className="text-sm text-gray-400 uppercase tracking-wider mb-1">Temporal Governance</div>
        ...
        <div className="score-panel p-4 bg-gray-800 rounded-md">
          <div className="text-sm text-gray-400 uppercase tracking-wider mb-1">Deterioration & Fatigue</div>
        ...
        <div className="score-panel p-4 bg-gray-800 rounded-md">
          <div className="text-sm text-gray-400 uppercase tracking-wider mb-1">Responsiveness & Recurrence</div>
          <div className="grid grid-cols-2 gap-4 mt-2">
            <div>
      ...
      <div className="mt-6 text-xs text-gray-500 flex justify-between border-t border-gray-800 pt-4">
        <div>Confidence: <span className="font-mono text-gray-300">{confidenceState.level}</span></div>
