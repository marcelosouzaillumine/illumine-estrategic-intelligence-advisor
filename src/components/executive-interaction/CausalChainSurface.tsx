          ...
          return (
            <div 
              ...
              className={`p-5 bg-slate-950/40 border rounded-xl cursor-pointer transition-all ${
                isSelected ? 'border-accent bg-accent' : 'border-border/10 hover:border-border'
              }`}
            >
              <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div className="flex items-center gap-3 flex-wrap">
                  <span className="text-xs font-bold text-muted-foreground uppercase tracking-wider bg-slate-900 border border-border/5 px-3 py-1.5 rounded-lg">
                    {edge.sourceLabel}
                  </span>
                ...
                <div className="flex items-center gap-3">
                  <span className="text-[10px] text-muted-foreground font-mono">{t("overlays.estimated_impact")}</span>
