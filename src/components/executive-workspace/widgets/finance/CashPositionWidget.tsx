...
export function CashPositionWidget({ value, trend }: CashPositionWidgetProps) {
  ...
  return (
    <div className="bg-surface-elevated border border-border rounded-xl p-5 shadow-sm h-full flex flex-col justify-center">
      <h3 className="text-xs font-semibold uppercase tracking-wider text-muted-foreground mb-1">Geração de Caixa Livre</h3>
      ...
      <div className="flex items-center gap-1.5 mt-3 text-sm">
        ...
        <span className="text-muted-foreground font-medium">Estável</span>
      </div>
    </div>
  );
}
