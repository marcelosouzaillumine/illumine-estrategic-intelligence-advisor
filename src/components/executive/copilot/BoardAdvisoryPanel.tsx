...
export interface BoardAdvisoryPanelProps {
...
export function BoardAdvisoryPanel({ messages, isProcessing, suggestedQuestions, onAskQuestion, onClear }: BoardAdvisoryPanelProps) {
        ...
        <div className="lg:col-span-2 p-6 flex flex-col bg-slate-950/30">
          ...
          {messages.length === 0 ? (
            <div className="flex-1 flex flex-col items-center justify-center text-center px-8 opacity-60">
              ...
              <h4 className="text-sm font-black text-muted-foreground mb-2">Advisory Read-Only</h4>
