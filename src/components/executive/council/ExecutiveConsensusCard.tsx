...
export interface ExecutiveConsensusCardProps {
  readonly score: number;
}

export const ExecutiveConsensusCard: React.FC<ExecutiveConsensusCardProps> = ({ score }) => {
  return (
      ...
      <div className="flex items-center justify-between gap-2">
        <div className="flex items-center gap-2">
          ...
          <ExecutiveText variant="bodyStandard" className="font-semibold text-foreground">
            Índice de Consenso do Conselho
          </ExecutiveText>
        </div>
