...
export const RuntimeDisclosureBanner: React.FC<RuntimeDisclosureBannerProps> = ({ narrative }) => {
  ...
  return (
    <div className={`w-full p-4 flex items-center justify-between border-b ${isLowConfidence || hasCritical ? 'bg-red-900 text-white' : 'bg-primary text-white'}`}>
      <div className="flex items-center gap-3">
        ...
        <div>
          <h4 className="font-semibold uppercase tracking-wider text-sm">Runtime Disclosure</h4>
          <p className="text-sm">
      ...
      {narrative.violations.length > 0 && (
        <div className="text-sm font-mono bg-black/50 px-3 py-1 rounded">
