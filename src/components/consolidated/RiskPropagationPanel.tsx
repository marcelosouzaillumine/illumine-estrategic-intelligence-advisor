  ...
  return (
    <div className="bg-white rounded-[32px] p-8 border border-border shadow-sm">
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          <h3 className="text-sm font-black text-muted-foreground uppercase tracking-widest">Causalidade Estrutural</h3>
          <p className="text-[10px] text-muted-foreground uppercase font-bold tracking-widest mt-0.5">Mapeamento Causa-Efeito</p>
        </div>
      </div>
      
      <div className="space-y-4">
        {causalities.map((causal, idx) => (
          <div key={idx} className="p-5 rounded-2xl border border-border bg-slate-50 flex flex-col gap-3">
            ...
            {causal.financialEvidence && (
              <div className="mt-2 text-[10px] text-muted-foreground bg-white p-2 rounded border border-border">
