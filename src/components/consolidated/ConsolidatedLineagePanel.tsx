...
export function ConsolidatedLineagePanel() {
  ...
  return (
    <div className="bg-slate-900 text-white rounded-[32px] p-8 border border-border shadow-xl">
      <div className="flex items-center gap-3 mb-4">
        ...
        <div>
          ...
          <p className="text-[10px] text-muted-foreground uppercase font-bold tracking-widest mt-0.5">Integridade Ponto-a-Ponto</p>
        </div>
      </div>
