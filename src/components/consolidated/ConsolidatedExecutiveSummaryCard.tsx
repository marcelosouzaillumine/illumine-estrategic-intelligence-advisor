  ...
  return (
    <div className="bg-slate-900 text-white rounded-[32px] p-8 border border-slate-800 shadow-2xl relative overflow-hidden flex flex-col group">
      ...
      <div className="flex items-center gap-3 mb-6 relative z-10">
        ...
        <div>
          <h3 className="text-sm font-bold text-white/90 uppercase tracking-widest">Executive Summary</h3>
          <p className="text-[10px] text-white/50 uppercase font-bold tracking-widest mt-0.5">Diagnóstico Consolidado</p>
        </div>
      </div>
