  ...
  return (
    <div className={cn("bg-white border border-border rounded-[32px] p-6 shadow-sm", className)}>
      <div className="flex items-center gap-2 mb-6">
        ...
        <span className="text-[10px] font-black uppercase tracking-widest text-muted-foreground">Perfil de Calibração Ativo</span>
      </div>

      <div className="flex flex-col md:flex-row gap-6 items-start md:items-center">
        
        {/* Profile Card */}
        <div className="bg-slate-50 border border-border rounded-2xl p-5 w-full md:w-auto md:min-w-[280px]">
          <div className="flex items-center gap-2.5">
            <div className="w-2.5 h-2.5 rounded-full bg-primary block" />
            <span className="text-[10px] font-black uppercase tracking-widest text-muted-foreground">Active Profile</span>
          </div>
          <p className="text-xl font-black text-muted-foreground tracking-tight mt-2 uppercase">
            {activeProfileId}
          </p>
        ...
        <div className="flex-1">
          <div className="flex gap-2.5 items-start">
            ...
            <div>
              ...
              <p className="text-[10px] font-semibold text-muted-foreground mt-2 leading-relaxed">
