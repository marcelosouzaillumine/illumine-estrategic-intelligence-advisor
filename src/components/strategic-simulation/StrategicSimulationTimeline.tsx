    ...
    <div className="bg-surface-container border border-border rounded-lg p-6">
      ...
      <div className="relative border-l border-border/50 ml-3 space-y-6 mt-4">
        <div className="relative pl-6">
          <div className="absolute w-3 h-3 bg-emerald-500 rounded-full -left-1.5 top-1.5 border-2 border-background"></div>
        ...
        <div className="relative pl-6">
          <div className="absolute w-3 h-3 bg-amber-500 rounded-full -left-1.5 top-1.5 border-2 border-background"></div>
