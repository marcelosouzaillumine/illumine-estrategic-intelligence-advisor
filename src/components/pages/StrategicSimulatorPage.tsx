      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
        ...
        <div className="lg:col-span-8 space-y-10">
          ...
          <div className="bg-white p-12 rounded-[56px] border border-slate-100 shadow-sm relative overflow-hidden">
             ...
             <div className="mt-16 p-10 bg-emerald-50 rounded-[40px] border border-emerald-100 flex flex-col md:flex-row items-center gap-8">
                ...
                <button className="px-10 py-5 bg-emerald-600 text-white rounded-[20px] text-[10px] font-black uppercase tracking-[0.2em] shadow-xl shadow-emerald-600/20 hover:bg-emerald-500 transition-all">
                  SALVAR CENÁRIO
                </button>
             </div>
          </div>
