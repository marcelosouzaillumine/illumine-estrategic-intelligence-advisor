    ...
    return (
      <div className="flex flex-col items-center justify-center min-h-[600px] space-y-10 animate-executive-fade">
         ...
         <div className="text-center space-y-4 max-w-xl mx-auto px-6">
            <h2 className="text-4xl font-display font-black text-slate-900 tracking-tight leading-tight">Relatório Executivo Silencioso</h2>
      ...
      <div className="flex items-center justify-between gap-4 flex-wrap bg-white/60 p-4 rounded-3xl border border-slate-200/60 backdrop-blur-sm shadow-sm -mt-6 mb-10">
        <div className="flex items-center gap-3">
          <select 
            ...
            className="bg-white border border-slate-200 rounded-2xl px-6 py-2.5 text-[10px] font-black uppercase tracking-widest text-slate-900 outline-none cursor-pointer hover:border-secondary/30 transition-all"
          >
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            className="flex items-center gap-2 px-6 py-2.5 bg-white border border-slate-200 text-slate-600 rounded-2xl font-black uppercase tracking-widest text-[10px] hover:bg-slate-50 transition-all disabled:opacity-50"
          >
          ...
          <button
            ...
            className="flex items-center gap-2 px-8 py-2.5 bg-secondary text-white rounded-2xl font-black uppercase tracking-widest text-[10px] hover:shadow-xl hover:shadow-secondary/20 transition-all shadow-lg shadow-secondary/10 disabled:opacity-50"
          >
