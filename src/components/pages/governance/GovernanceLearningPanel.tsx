      ...
      {isBlocked ? (
        ...
        <>
          ...
          {learning.feedbackMode === 'SIMULATED_FEEDBACK' && (
            <div className="p-4 bg-indigo-500/10 border border-indigo-500/20 text-indigo-400 rounded-2xl flex items-start gap-3 shadow-md shadow-indigo-500/5">
              ...
              <div className="space-y-1 text-xs">
                ...
                <p className="text-[10px] text-indigo-400/80 leading-normal">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-black/20 border border-gray-800/80 rounded-2xl p-6 flex flex-col items-center justify-between text-center relative overflow-hidden">
              <div className="absolute top-2 left-2 flex items-center gap-1">
                ...
                <span className="text-[9px] font-black text-gray-500 uppercase tracking-widest">GLI™ INDEX</span>
              </div>
              ...
              <div className="relative flex items-center justify-center my-4">
                ...
                <div className="absolute flex flex-col items-center justify-center">
                  ...
                  <span className="text-[8px] font-bold text-gray-500 uppercase tracking-wider">GLI™ Score</span>
                </div>
              </div>
            ...
            <div className="bg-black/20 border border-gray-800/80 rounded-2xl p-6 flex flex-col items-center justify-between text-center relative overflow-hidden">
              <div className="absolute top-2 left-2 flex items-center gap-1">
                ...
                <span className="text-[9px] font-black text-gray-500 uppercase tracking-widest">AAI™ INDEX</span>
              </div>
              ...
              <div className="relative flex items-center justify-center my-4">
                ...
                <div className="absolute flex flex-col items-center justify-center">
                  ...
                  <span className="text-[8px] font-bold text-gray-500 uppercase tracking-wider">AAI™ Score</span>
                </div>
              </div>
            ...
            <div className="bg-black/20 border border-gray-800/80 rounded-2xl p-6 flex flex-col justify-between space-y-4">
              <span className="text-[10px] font-black text-gray-400 uppercase tracking-widest block">Análise de Malha de Aprendizado</span>
              ...
              <div className="text-[10px] text-gray-550 border-t border-gray-800 pt-3 leading-relaxed">
                ...
                <p className="font-mono text-[9px] text-gray-450 mt-1 break-all select-all">{learning.lineageHash}</p>
              </div>
            </div>
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {learning.observations.map((obs, idx) => {
                ...
                return (
                  <div key={idx} className="p-4 bg-slate-950/40 border border-gray-850 hover:border-gray-800 transition-all rounded-2xl space-y-3 relative overflow-hidden">
                    <div className="flex justify-between items-start">
                      <div className="space-y-0.5">
                        <span className="text-[8px] font-bold text-gray-500 uppercase tracking-widest block font-mono">{obs.id} / Fonte: {obs.source}</span>
                    ...
                    <div className="grid grid-cols-2 gap-4 border-t border-gray-850 pt-2 text-[10px]">
                      <div>
                        <span className="text-gray-500 block uppercase font-bold text-[8px]">Esperado:</span>
                        <p className="text-gray-350">{obs.expectedOutcome}</p>
                      </div>
                      <div>
                        <span className="text-gray-500 block uppercase font-bold text-[8px]">Real Obtido:</span>
                        <p className="text-gray-300">{obs.actualOutcome}</p>
                      </div>
                    </div>

                    <div className="p-3 bg-black/40 border border-gray-850 rounded-xl space-y-2">
                      <div>
                        <span className="text-[8px] font-black uppercase text-indigo-400 tracking-wider block">Lição Aprendida</span>
                        <p className="text-[10px] text-gray-400 italic leading-relaxed">{obs.lessonsLearned[0]}</p>
                      </div>
                      
                      {obs.expectedImpact !== undefined && (
                        <div className="flex justify-between items-center text-[9px] border-t border-gray-850/50 pt-1 text-gray-500">
                          <span>Eficácia: <strong className="text-emerald-400">{obs.effectivenessScore}%</strong></span>
                          <span>Impacto (Proj vs Real): <strong className="text-indigo-450">{obs.expectedImpact} vs {obs.actualImpact} BPS</strong></span>
                          <span>Var: <strong className={obs.variance === 0 ? 'text-gray-400' : 'text-amber-400'}>{obs.variance} BPS</strong></span>
                        </div>
                      )}
                    </div>
                  </div>
            ...
            <div className="p-5 bg-black/15 border border-gray-800/50 rounded-2xl space-y-3">
              ...
              <div className="space-y-2">
                {learning.institutionalStrengths.length > 0 ? (
                  ...
                  <p className="text-xs text-gray-500 italic">Nenhum padrão repetitivo de sucesso fiduciário consolidado.</p>
                )}
              </div>
            </div>
