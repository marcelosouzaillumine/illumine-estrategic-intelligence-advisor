      ...
      <div className="space-y-6">
        <div className="grid grid-cols-2 gap-4">
          <div className="p-3 bg-black/40 rounded-lg border border-gray-800">
            <span className="text-xs text-gray-500 uppercase font-semibold">{t('cgd.lineage.constitutionalHash')}</span>
            <div className="text-sm font-mono text-indigo-300 mt-1 truncate">{lineage.constitutionalHash}</div>
          </div>
          <div className="p-3 bg-black/40 rounded-lg border border-gray-800">
            <span className="text-xs text-gray-500 uppercase font-semibold">{t('cgd.lineage.runtimeHash')}</span>
        ...
        <div className="flex items-center justify-between p-4 bg-gray-800/50 rounded-lg">
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="text-sm text-gray-300">{t('cgd.lineage.traceability')}</div>
              <div className="text-xs text-gray-500 font-mono mt-0.5">{lineage.traceabilityStatus}</div>
            </div>
          </div>
          <div className="text-right">
            <div className="text-sm text-white font-medium">{lineage.evidenceCount}</div>
            <div className="text-xs text-gray-500">{t('cgd.lineage.evidenceCount')}</div>
          </div>
        </div>
