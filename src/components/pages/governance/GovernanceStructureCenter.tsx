          ...
          <div className="card-premium p-8">
            ...
            <div className="aspect-video bg-slate-950/60 rounded-xl border border-border/10 flex items-center justify-center relative overflow-hidden shadow-inner">
               <div className="text-center">
                  ...
                  <p className="text-slate-500 text-xs font-bold uppercase tracking-wider">Organograma Dinâmico Renderizado Aqui</p>
               </div>
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {['Comitê de Auditoria e Riscos', 'Comitê de Pessoas e Cultura', 'Comitê de Inovação', 'Comitê ESG e Ética'].map((comite, idx) => (
                <div key={idx} className="p-4 bg-slate-950/40 border border-border/10 rounded-xl flex items-start gap-3">
                  <div className="p-2 bg-slate-900 rounded-lg text-slate-400 border border-border/5">
        ...
        <div className="space-y-6">
            ...
            <div className="space-y-6">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-500 mt-0.5 leading-relaxed">Nenhum diretor executa e aprova o mesmo orçamento.</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
          ...
          <div className="card-premium p-8">
            ...
            <div className="space-y-4">
              ...
              <div className="mt-6 p-4 bg-slate-950/40 border border-border/10 rounded-xl text-xs text-slate-400 text-center leading-relaxed">
