...
import { useInstitutionalBenchmarkingViewModel } from '../../../capabilities/assessment-monitoring/presentation/view-models/useInstitutionalBenchmarkingViewModel';
...
export function InstitutionalBenchmarkingPage() {
  const { execution, sector, setSector } = useInstitutionalBenchmarkingViewModel();
