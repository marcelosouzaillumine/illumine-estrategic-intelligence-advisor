        ...
        <div className="max-w-7xl mx-auto px-2 min-[400px]:px-6 h-full flex items-center justify-between gap-2 md:gap-4">
          ...
          <div className="flex items-center gap-1.5 min-[400px]:gap-2 md:gap-4 ml-auto lg:ml-0 shrink-0">
            ...
            <Button 
              ...
              className="h-6 min-[400px]:h-8 md:h-9 px-2 min-[400px]:px-3 md:px-4 rounded-[6px] md:rounded-[10px] font-bold text-[6px] min-[370px]:text-[7px] sm:text-[9px] md:text-[10px] uppercase tracking-tight md:tracking-widest flex items-center gap-1 md:gap-1.5 whitespace-nowrap"
            >
