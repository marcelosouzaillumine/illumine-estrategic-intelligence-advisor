  ...
  return (
    <main className="min-h-screen bg-background flex flex-col justify-center items-center p-4 relative overflow-hidden selection:bg-primary/20 selection:text-primary">
      ...
      <motion.div
        ...
        className="relative w-full max-w-[460px] rounded-card bg-card/95 backdrop-blur-2xl border border-border/60 shadow-2xl flex flex-col z-10"
        style={{
      ...
      >
        ...
        {/* Header */}
        <div className="relative bg-gradient-to-b from-primary/8 to-transparent p-6 sm:p-8 pb-4 border-b border-border/40 shrink-0">
          <div className="flex items-center gap-3 mb-4">
            <div className="w-10 h-10 rounded-button bg-primary border border-primary/20 flex items-center justify-center">
          ...
          <p className="mt-1.5 text-sm leading-relaxed text-muted-foreground font-medium font-sans">
        ...
        <div className="p-6 sm:p-8 space-y-4">
          <form onSubmit={handleEmailLogin} className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <div className="relative group">
                ...
                <Input
                  ...
                  className="pl-10 h-12 bg-surface-container/40"
                />
              </div>
            </div>
            ...
            <div className="space-y-2">
              ...
              <div className="relative group">
                ...
                <Input
                  ...
                  className="pl-10 pr-10 h-12 bg-surface-container/40"
                />
                <button
                  type="button"
            ...
            <Button
              ...
              className="w-full h-12 font-bold text-sm text-primary-foreground uppercase tracking-widest flex items-center justify-center gap-2"
            >
          ...
          {/* Security note */}
          <div className="rounded-button bg-surface-container/40 border border-border/60 p-3 mt-4">
