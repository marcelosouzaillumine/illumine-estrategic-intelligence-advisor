      ...
      <section className="relative pt-48 pb-24 px-6 overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          <h1 className="text-5xl md:text-6xl font-bold tracking-tight text-white mb-6">
            ...
            A capacidade ideal para cada organização.
          </h1>
          <p className="text-xl text-slate-400 mb-10 max-w-3xl mx-auto leading-relaxed">
            Transforme dados em decisões executivas com uma plataforma desenvolvida para Conselhos, Diretorias e líderes que desejam governar com inteligência, previsibilidade e segurança.
          </p>
