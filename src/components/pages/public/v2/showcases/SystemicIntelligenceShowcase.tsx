...
export function SystemicIntelligenceShowcase() {
  const stats = {
    ...
    ebitda: 45000000,
    resonanceData: [
      { subject: 'Governança', A: 95, fullMark: 100 },
      { subject: 'Cultura', A: 88, fullMark: 100 },
      { subject: 'Finanças', A: 92, fullMark: 100 },
      { subject: 'Inovação', A: 85, fullMark: 100 },
      { subject: 'Marketing', A: 90, fullMark: 100 },
      { subject: 'Comercial', A: 94, fullMark: 100 },
      { subject: 'Operacional', A: 89, fullMark: 100 },
    ],
    frictionSources: [
      { name: 'Silos de Dados', value: 35, impact: 'High' },
      { name: 'Processos Manuais', value: 25, impact: 'High' },
      { name: 'Alinhamento Liderança', value: 20, impact: 'Medium' },
      { name: 'Retenção Talentos', value: 20, impact: 'Medium' },
    ],
    warnings: [
      {
        id: 'warn-1',
          ...
          <div className="flex items-center justify-between gap-4 flex-wrap bg-zinc-900/60 p-4 rounded-md border border-zinc-800 backdrop-blur-sm shadow-sm mb-10">
            <div className="flex items-center gap-3">
              <div className="px-4 md:px-6 py-2 md:py-3 bg-zinc-950 border border-zinc-800 rounded-md shadow-sm flex items-center gap-4">
                <div>
                  <span className="text-[10px] font-medium text-zinc-500 uppercase tracking-widest block mb-1">Score de Integração</span>
                  <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-3">
              <div className="px-4 py-2.5 bg-zinc-950 border border-zinc-800 rounded-md shadow-sm flex items-center gap-2">
                ...
                <span className="text-[10px] font-medium uppercase tracking-widest text-zinc-500">Análise Multidimensional Ativa</span>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 xl:grid-cols-3 gap-8">
            ...
            <div className="bg-zinc-950 border border-zinc-800 p-8 rounded-lg flex flex-col">
              <div className="flex items-center justify-between mb-8">
                <div>
                  ...
                  <p className="text-[10px] text-zinc-500 font-medium mt-1 uppercase tracking-widest">Alinhamento de maturidade por área de gestão.</p>
                </div>
              </div>
            ...
            <div className="bg-zinc-950 border border-zinc-800 p-8 rounded-lg flex flex-col">
              <div className="flex items-center justify-between mb-8">
                <div>
                  ...
                  <p className="text-[10px] text-zinc-500 font-medium mt-1 uppercase tracking-widest">EBITDA drenado por ineficiências reais.</p>
                </div>
                <div className="text-right">
                  <span className="text-2xl font-medium text-red-500">{stats.frictionIndex}%</span>
                  <span className="text-[8px] font-medium text-zinc-500 block uppercase tracking-widest">Perda do EBITDA</span>
                </div>
              </div>
                ...
                <ResponsiveContainer width="100%" height="100%">
                  <BarChart data={stats.frictionSources} layout="vertical" margin={{ left: 20 }}>
                    ...
                    <Tooltip 
                      ...
                      formatter={(val: number) => [`${val}%`, 'Contribuição']}
                    />
              ...
              <div className="flex items-center justify-between p-3 rounded-md border bg-zinc-900 border-zinc-800">
                <span className="text-[10px] font-medium uppercase tracking-widest text-zinc-400">Impacto Estimado</span>
            ...
            <div className="bg-zinc-950 p-8 rounded-lg border border-zinc-800 text-zinc-100 relative overflow-hidden flex flex-col justify-center">
              ...
              <div className="relative z-10">
                <h3 className="text-amber-500 font-medium text-[10px] uppercase tracking-widest mb-4">Múltiplo de Governança</h3>
                <h2 className="text-4xl font-medium tracking-tight leading-tight mb-6">
                  +{stats.valuationPremium}% <span className="text-zinc-500 text-2xl block mt-1">Premium Valuation</span>
                </h2>
