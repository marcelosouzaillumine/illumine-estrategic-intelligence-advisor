    ...
    <ExecutivePageTemplate header={{
      ...
      <div className="space-y-8 pb-32">
        ...
        <ExecutiveSummarySection 
          ...
          executiveQuestion="Ajustar atribuições nos departamentos com span de controle excessivo."
        >
      ...
      <AnimatePresence mode="wait">
       ...
       <ExecutiveSummarySection 
         ...
         executiveQuestion="Ajustar atribuições operacionais nos departamentos com amplitude descalibrada."
       >
         <ExecutiveStrategicTensions tensions={[]} />
         <ExecutiveDecisionTrace trace={[]} />
        </ExecutiveSummarySection>
