  ...
  return (
    <ExecutivePageTemplate header={{
      ...
      <ExecutiveSummarySection 
        ...
        executiveQuestion="Implementar planos de manutenção preditiva e otimizar rotas logísticas."
      >
      ...
      >
       ...
       <ExecutiveSummarySection 
         ...
         executiveQuestion="Acompanhar e implementar as recomendações de Lean Manufacturing sugeridas."
       >
         <ExecutiveStrategicTensions tensions={[]} />
         <ExecutiveDecisionTrace trace={[]} />
       </ExecutiveSummarySection>
