    ...
    <ExecutivePageTemplate header={{
      ...
      description: "O DNA e o norte estratégico da organização — Propósito, Missão, Visão e Valores.",
       ...
       <ExecutiveSummarySection 
         ...
         executiveQuestion="Promover workshops de aculturamento para engajar 100% dos liderados nas diretrizes aprovadas."
       >
      ...
      <ExecutiveSummarySection 
        ...
        executiveQuestion="Revisar anualmente no planejamento estratégico as diretrizes institucionais."
      >
        <ExecutiveStrategicTensions tensions={[]} />
        <ExecutiveDecisionTrace trace={[]} />
      </ExecutiveSummarySection>
