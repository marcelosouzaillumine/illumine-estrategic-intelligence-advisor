  ...
  return (
    <div className="bg-zinc-950 border border-zinc-800 p-6 rounded-lg font-mono">
      ...
      <div className="flex items-center gap-8 mb-6">
        <div>
          <span className="text-[9px] text-zinc-500 uppercase font-bold tracking-widest block mb-1">Resilience Status</span>
          <span className="text-lg text-emerald-400 font-bold uppercase tracking-widest block">
            {data.resilienceStatus}
          </span>
        </div>
        <div>
          <span className="text-[9px] text-zinc-500 uppercase font-bold tracking-widest block mb-1">Antifragility Score</span>
