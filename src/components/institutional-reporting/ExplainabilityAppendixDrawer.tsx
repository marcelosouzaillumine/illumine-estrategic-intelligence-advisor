  ...
  return (
    <div className="bg-zinc-950 border border-zinc-800 p-6 rounded-lg font-mono">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div>
          <span className="text-[9px] text-zinc-500 uppercase font-bold tracking-widest block mb-4">Rationale Decomposition</span>
        ...
        <div>
          <span className="text-[9px] text-zinc-500 uppercase font-bold tracking-widest block mb-4">Confidence Decomposition</span>
