      ...
      <div>
        <div className="flex items-center justify-between mb-6">
          ...
          <span className={cn(
            ...
            data.fatigueLevel === 'CRITICAL' ? 'bg-destructive/10 text-destructive border-destructive/20' :
            data.fatigueLevel === 'HIGH' ? 'bg-amber-500/10 text-amber-500 border-amber-500/20' :
