...
const RBAC_PERMISSION_MATRIX: Record<OfficialRole, OfficialAction[]> = {
  ...
  MENTOR: [
    'VIEW_MENTORING_SESSION', 'CREATE_MENTORING_SESSION',
    'VIEW_MENTOR_PROFILE', 'VIEW_MENTEE_PROFILE'
  ],
  MENTEE: [
    'VIEW_MENTORING_SESSION',
    'VIEW_MENTEE_PROFILE', 'VIEW_MENTOR_PROFILE'
  ],
  PROGRAM_ADMIN: [
    'VIEW_DASHBOARD', 'VIEW_MENTORING_SESSION', 'CREATE_MENTORING_SESSION',
    'VIEW_MENTOR_PROFILE', 'VIEW_MENTEE_PROFILE', 'MANAGE_USERS'
  ]
};
