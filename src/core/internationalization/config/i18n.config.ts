...
const resources = {
  'pt-BR': {
    ...
    'showcases/systemic-governance': ptBrShowcasesSystemic,
    'showcases/governance': ptBrShowcasesGovernance,
    'governance-center': ptBrIntelligenceCenter,
  ...
  'en-US': {
    ...
    'showcases/systemic-governance': enUsShowcasesSystemic,
    'showcases/governance': enUsShowcasesGovernance,
    'governance-center': enUsIntelligenceCenter,
  ...
  'es-ES': {
    ...
    'showcases/systemic-governance': esEsShowcasesSystemic,
    'showcases/governance': esEsShowcasesGovernance,
    'governance-center': esEsIntelligenceCenter,
...
i18n
  ...
  .init({
    ...
    ns: [
      ...
      'showcases/executive-command', 'showcases/systemic-governance', 'showcases/governance', 'governance-center', 'diagnostic', 'workspace', 'settings', 'permissions', 'advisor-network',
