...
export const GovernanceCatalog: GovernanceRecommendation[] = [
  ...
  { id: 'gov-04', category: 'Governança', title: 'Criar Comitê de Estratégia', description: 'Fórum especializado para monitoramento do plano de negócios e contextos estruturais.', impactLevel: 'Alto', implementationEffort: 'Médio', triggerIRGThreshold: 30, triggerGPIThreshold: 40 },
