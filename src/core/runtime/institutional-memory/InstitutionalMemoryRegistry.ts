...
const DEMO_SEEDS: InstitutionalMemoryRecord[] = [
  {
    ...
    narrativeSnapshot: 'Sinais iniciais de deterioração no ciclo de caixa ciclo imediato.',
    causalSummary: 'Aumento do ciclo médio de estoques e redução de liquidez imediata.',
  ...
  },
  {
    ...
    causalSummary: 'Consumo acelerado de caixa e necessidade de funding de ciclo imediato.',
