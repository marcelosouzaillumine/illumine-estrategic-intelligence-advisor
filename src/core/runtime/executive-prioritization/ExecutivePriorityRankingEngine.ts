  ...
  public static rank(report: any): RatedRecommendation[] {
    ...
    if (netProfit < 0 || breakEvenGap > 0) {
      ...
      list.push({
        ...
        prazoRecomendadoLabel: 'médio ciclo',
        impactLabel: 'Muito Alto',
        urgencyLabel: urgencyScore >= 90 ? 'Imediata' : 'ciclo imediato',
        impactScore,
        urgencyScore,
        effortScore,
        eps,
    ...
    if (netProfit < 0 || Math.abs(ebitda) > 0) {
      ...
      list.push({
        ...
        prazoRecomendadoLabel: 'ciclo imediato',
        impactLabel: 'Muito Alto',
        urgencyLabel: 'ciclo imediato',
        impactScore,
        urgencyScore,
        effortScore,
        eps,
    ...
    if (fco < 0 || (runwayMonths > 0 && runwayMonths < 6)) {
      ...
      list.push({
        ...
        action: 'Suspender investimentos de capital (CAPEX) não prioritários e otimizar ciclos do ciclo financeiro.',
        ...
        eps,
        classification: this.getClassification(eps),
        consequenciaInacao: 'Ruptura de caixa de ciclo imediato e interrupção forçada das atividades.',
    ...
    if (list.length === 0) {
      ...
      list.push({
        ...
        prazoRecomendadoLabel: 'longo horizonte',
        impactLabel: 'Baixo',
        urgencyLabel: 'longo horizonte',
        impactScore,
        urgencyScore,
        effortScore,
        eps,
        classification: this.getClassification(eps),
        consequenciaInacao: 'Perda gradual de controle orçamentário no longo horizonte.',
