...
const NARRATIVES: Record<EngineModule, Record<HealthStatus, VariationSet[]>> = {
  LIQUIDITY: {
    EXCELLENT: [
      ...
      { primaryDriver: 'Blindagem de ciclo imediato', executiveNarrative: 'A liquidez supera significativamente o patamar necessário para suportar as operações correntes, sugerindo oportunidade de otimização da estrutura de capital e melhoria da eficiência na alocação dos recursos.', managerialImplication: 'A relação de liquidez comprova solidez absoluta frente a obrigações vincendas.', priorityAction: 'Manter estratégia atual e avaliar alocação de excedentes de caixa em operações de maior rentabilidade.' }
    ],
    HEALTHY: [
      { primaryDriver: 'Cobertura de caixa adequada', executiveNarrative: 'O perfil de liquidez é saudável e suficiente para o giro normal dos negócios, sem sinais de pressão iminente.', managerialImplication: 'Os ativos circulantes suportam as dívidas de ciclo imediato de maneira orgânica.', priorityAction: 'Monitorar ciclo financeiro para garantir a estabilidade da cobertura de ciclo imediato.' },
      { primaryDriver: 'Liquidez orgânica preservada', executiveNarrative: 'A companhia demonstra capacidade adequada de cobertura das suas obrigações táticas.', managerialImplication: 'O fluxo de conversão permite a quitação de passivos dentro dos ciclos estipulados.', priorityAction: 'Monitorar ciclo financeiro para garantir a estabilidade da cobertura de ciclo imediato.' },
      { primaryDriver: 'Estabilidade de ciclo imediato', executiveNarrative: 'As obrigações imediatas estão bem equalizadas com a capacidade de geração de liquidez.', managerialImplication: 'Existe equilíbrio entre direitos de ciclo imediato e exigibilidades.', priorityAction: 'Monitorar ciclo financeiro para garantir a estabilidade da cobertura de ciclo imediato.' }
    ],
    WARNING: [
      { primaryDriver: 'Liquidez sob pressão', executiveNarrative: 'A capacidade de pagamento de ciclo imediato apresenta desgaste, exigindo monitoramento ativo do fluxo de caixa.', managerialImplication: 'O volume de exigibilidades está pressionando a margem de segurança disponível.', priorityAction: 'Otimizar gestão do capital de giro e revisar ciclos de pagamentos e recebimentos.' },
      { primaryDriver: 'Aperto tático no caixa', executiveNarrative: 'Observa-se um descasamento tático entre a velocidade de conversão dos ativos e as obrigações imediatas.', managerialImplication: 'Redução na folga financeira demanda ações de otimização de tesouraria.', priorityAction: 'Otimizar gestão do capital de giro e revisar ciclos de pagamentos e recebimentos.' },
      { primaryDriver: 'Cobertura imediata frágil', executiveNarrative: 'A margem de liquidez está comprimida, indicando potencial necessidade de reperfilamento ou injeção de capital.', managerialImplication: 'Os ativos líquidos atuais atendem parcialmente as obrigações sem esforço adicional.', priorityAction: 'Otimizar gestão do capital de giro e revisar ciclos de pagamentos e recebimentos.' }
    ],
    CRITICAL: [
      ...
      { primaryDriver: 'Risco sistêmico de ciclo imediato', executiveNarrative: 'A empresa enfrenta uma asfixia financeira, não havendo ativos líquidos suficientes para as obrigações correntes.', managerialImplication: 'O déficit de liquidez compromete diretamente o fluxo operacional básico.', priorityAction: 'Acionar plano de contingência para injeção de liquidez imediata ou renegociação de exigibilidades.' },
      { primaryDriver: 'Falta de cobertura tática', executiveNarrative: 'O passivo circulante supera criticamente as vias de geração de caixa de ciclo imediato.', managerialImplication: 'contexto de insolvência tática exigindo intervenção imediata da gestão.', priorityAction: 'Acionar plano de contingência para injeção de liquidez imediata ou renegociação de exigibilidades.' }
    ],
    INSUFFICIENT_DATA: [
  ...
  ASSET_QUALITY: {
    ...
    CRITICAL: [
      { primaryDriver: 'Engessamento patrimonial', executiveNarrative: 'O balanço demonstra um excesso crítico de ativos imobilizados ou de longo horizonte, anulando a capacidade de resposta.', managerialImplication: 'Baixíssima qualidade no giro e recursos severamente aprisionados.', priorityAction: 'Executar desinvestimento imediato de ativos não essenciais para recompor liquidez.' },
  ...
  WORKING_CAPITAL: {
    ...
    HEALTHY: [
      { primaryDriver: 'Capital de giro estável', executiveNarrative: 'O ciclo financeiro deve ser acompanhado continuamente para assegurar que o crescimento operacional não resulte em consumo estrutural excessivo de caixa.', managerialImplication: 'A necessidade operacional está coberta pelos recursos de ciclo imediato.', priorityAction: 'Manter monitoramento de ciclos médios de estocagem, recebimento e pagamento.' },
      { primaryDriver: 'Ciclo financeiro controlado', executiveNarrative: 'O ciclo financeiro deve ser acompanhado continuamente para assegurar que o crescimento operacional não resulte em consumo estrutural excessivo de caixa.', managerialImplication: 'Giro da operação não impõe pressão indevida no caixa.', priorityAction: 'Manter monitoramento de ciclos médios de estocagem, recebimento e pagamento.' },
      { primaryDriver: 'Conformidade de ciclo imediato', executiveNarrative: 'O ciclo financeiro deve ser acompanhado continuamente para assegurar que o crescimento operacional não resulte em consumo estrutural excessivo de caixa.', managerialImplication: 'A gestão de estoques e recebíveis suporta o ciclo de pagamento.', priorityAction: 'Manter monitoramento de ciclos médios de estocagem, recebimento e pagamento.' }
    ],
    WARNING: [
      { primaryDriver: 'Desalinhamento no ciclo de caixa', executiveNarrative: 'Nota-se uma pressão incipiente sobre o capital de giro, possivelmente devido ao alongamento de clientes ou estoques.', managerialImplication: 'A Necessidade de Capital de Giro (NCG) aproxima-se dos limites críticos de cobertura.', priorityAction: 'Acelerar recebíveis, renegociar ciclos com fornecedores e otimizar níveis de estoque.' },
      { primaryDriver: 'Tensão no giro operacional', executiveNarrative: 'O ciclo de conversão de caixa está gerando atritos, exigindo captação para suportar o período de defasagem.', managerialImplication: 'Redução do Saldo de Tesouraria impõe alertas de gestão.', priorityAction: 'Acelerar recebíveis, renegociar ciclos com fornecedores e otimizar níveis de estoque.' },
      { primaryDriver: 'Incompatibilidade tática', executiveNarrative: 'Os recursos destinados a suportar o ciclo imediato não são inteiramente suficientes para cobrir os ciclos de estoque.', managerialImplication: 'Risco moderado de ruptura no giro diário da empresa.', priorityAction: 'Acelerar recebíveis, renegociar ciclos com fornecedores e otimizar níveis de estoque.' }
    ],
    CRITICAL: [
      { primaryDriver: 'Colapso de capital de giro', executiveNarrative: 'A operação consome caixa de forma agressiva, demonstrando descontrole nos ciclos médios e forte dependência de rolagem.', managerialImplication: 'Necessidade de Capital de Giro estruturalmente descoberta.', priorityAction: 'Geração emergencial de caixa via antecipação de recebíveis e liquidação de estoques.' },
  ...
  PRESERVATION: {
    EXCELLENT: [
      { primaryDriver: 'Alta preservação de capital', executiveNarrative: 'A base de capital está plenamente preservada, garantindo altíssima resiliência a contextos adversos e sustentabilidade estrutural.', managerialImplication: 'Ampla margem de segurança e robusto patrimônio líquido.', priorityAction: 'Manter política de retenção de lucros equilibrada e avaliar oportunidades de expansão orgânica.' },
