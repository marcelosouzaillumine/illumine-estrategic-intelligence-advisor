...
import { ExecutiveLocaleEnforcer } from '../../enforcement/ExecutiveLocaleEnforcer';
import { InstitutionalSemanticGraph, SemanticSentence, SemanticTag } from '../coherence/InstitutionalSemanticGraph';
