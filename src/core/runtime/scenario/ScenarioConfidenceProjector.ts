...
export class ScenarioConfidenceProjector {
   ...
   * com o impacto da propagação do contexto.
   */
  static project(historicalConfidence: 'HIGH' | 'MEDIUM' | 'LOW', propagationResult: ScenarioPropagationResult): ProjectedConfidence {
    ...
    // Se o histórico já era baixo e o contexto gera MEDIUM, rebaixamos pro histórico ou pior.
    ...
    // Se a timeline do contexto leva a crise de liquidez em menos de criticalMonthsLimit, forçamos stress crítico
