...
export function runEvidenceAudit(
  ...
  let classification: 'SUPPORT_TOOL' | 'ANALYTICAL_TOOL' | 'DECISION_SUPPORT_SYSTEM' | 'GOVERNANCE_GOVERNANCE_PLATFORM' | 'INSTITUTIONAL_GOVERNANCE_PLATFORM' | 'INSTITUTIONAL_OPERATING_SYSTEM' = 'GOVERNANCE_GOVERNANCE_PLATFORM';
  ...
  if (predominantLevel === 'E3' || predominantLevel === 'E4') {
    classification = 'INSTITUTIONAL_GOVERNANCE_PLATFORM';
  ...
  if (classification === 'GOVERNANCE_GOVERNANCE_PLATFORM') strength = 'MODERATE';
  if (classification === 'INSTITUTIONAL_GOVERNANCE_PLATFORM') strength = 'STRONG';
