    ...
    evaluate: (data: NormalizedBalanceSheet) => {
      ...
      if (inventoryRatio >= 0.5) {
        return {
          ...
          triggerCondition: '>= 50%',
          message: 'Estoque representa mais de 50% dos ativos totais. Risco inerente de obsolescência e imobilização de capital.'
        };
        ...
        return {
          ...
          value: inventoryRatio,
          triggerCondition: '>= 35%',
          message: 'Concentração de estoques elevada em proporção ao ativo total.'
        };
    ...
    evaluate: (data: NormalizedBalanceSheet) => {
      ...
      if (cashRatio >= 0.5) {
        return {
          ...
          value: cashRatio,
          triggerCondition: '>= 50%',
          message: 'Excesso de liquidez. Mais de 50% dos ativos totais encontram-se em caixa e equivalentes.'
        };
      }
      return null;
    }
