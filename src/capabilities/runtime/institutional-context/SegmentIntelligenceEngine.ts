...
export class SegmentIntelligenceEngine {
  public resolveSegmentIntelligence(profile: InstitutionalBusinessProfile): SegmentIntelligenceProfile {
    ...
    return {
      ...
      assetIntensityProfile: result.assetIntensityProfile as unknown as "UNKNOWN",
      workingCapitalCycleProfile: result.workingCapitalCycleProfile as unknown as "UNKNOWN",
      revenueModelSensitivity: result.revenueModelSensitivity as unknown as "UNKNOWN",
      marginStructureProfile: result.marginStructureProfile as unknown as "UNKNOWN",
      governanceComplexityLevel: result.governanceComplexityLevel as unknown as "UNKNOWN",
      institutionalMaturityContext: result.institutionalMaturityContext as unknown as "UNKNOWN",
