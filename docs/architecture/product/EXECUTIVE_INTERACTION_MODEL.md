# EXECUTIVE_INTERACTION_MODEL.md — Modelo de Interação Executiva (Wave 16.5 Fase 0)

> **Documento Normativo Supremo de Experiência e Jornadas Executivas**  
> *Pacotes: `@illumine/executive-decision-workspace` & `@illumine/executive-board`*

---

## 1. As 6 Jornadas Executivas Fundamentais

| Persona Executiva | O que observa primeiro | Decisão principal requerida | Tempo dedicado diário | Agentes prioritários consultados | Ação esperada |
| :--- | :--- | :--- | :--- | :--- | :--- |
...
## 2. Executive Information Hierarchy (EIH)

Toda tela, workspace ou relatório na Illumine OS™ DEVE obedecer estritamente à hierarquia de informação:

$$\text{Signal} \rightarrow \text{Insight} \rightarrow \text{Finding} \rightarrow \text{Recommendation} \rightarrow \text{Decision} \rightarrow \text{Execution} \rightarrow \text{Outcome} \rightarrow \text{Learning}$$
