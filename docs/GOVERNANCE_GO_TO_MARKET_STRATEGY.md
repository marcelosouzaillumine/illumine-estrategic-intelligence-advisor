...
```mermaid
quadrantChart
    title Matriz de Priorização de Segmento (Potencial vs Complexidade)
    x-axis Baixa Complexidade --> Alta Complexidade
    y-axis Baixo Potencial --> Alto Potencial
    quadrant-1 Expandir no Longo Prazo
    quadrant-2 Beachhead / Foco Imediato
    quadrant-3 Evitar / Baixo Retorno
    quadrant-4 Oportunidades Adjacentes
    "BAM & Terceiro Setor": [0.25, 0.78]
    "Empresas Familiares": [0.45, 0.85]
    "Holdings & Grupos": [0.75, 0.90]
    "Indústrias": [0.55, 0.75]
    "Hospitais": [0.85, 0.88]
```
