...
1. **NO UI GOVERNANCE:** O PR não pode introduzir `if/else` no React baseado em valores numéricos para gerar interpretações. A interpretação de negócio deve ser requisitada ao Engine.
