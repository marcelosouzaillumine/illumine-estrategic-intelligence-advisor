  ...
  walkDir(dir, (filePath) => {
    if (filePath.endsWith('.tsx') || filePath.endsWith('.ts')) {
      ...
      if (filePath.endsWith('Page.tsx') || filePath.includes('/executive/') || filePath.includes('/pages/')) {
        ...
        if (filePath.includes('.test.') || filePath.includes('ViewModel') || filePath.includes('Service') || filePath.includes('Application') || filePath.includes('Context') || filePath.includes('Provider')) return;
